...
<head>
    ...
    <!---Nhúng thư viện soạn thảo văn bản -->
    <!---summernote--->
...
if (!empty($_POST)) {
    ...
    if (isset($_POST['price'])) {
		$price = $_POST['price'];
        $name = str_replace('"', '\\"', $price);
	}
    if (isset($_POST['thumbnail'])) {
		$thumbnail = $_POST['thumbnail'];
        $name = str_replace('"', '\\"', $thumbnail);
	}
...
?>
			...
			<div class="panel-body">
				<form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" row="5" name="content" id="content">
                            <?= $content?>
                        </textarea>
					</div>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            //đợi cho website load song nội dung -> sử lý phần js
            $('#content').summernote({
                height: 300,                 // đặt chiều cao của trình chỉnh sửa
                minHeight: null,             // đặt chiều cao tối thiểu của trình chỉnh sửa
                maxHeight: null,             // đặt chiều cao tối đa của trình chỉnh sửa
                focus: true                  // đặt tiêu điểm thành vùng có thể chỉnh sửa sau khi khởi tạo summernote
            });
        })
    </script>
</body>
